  ...
  <section class="home">
    ...
    <div class="swiper home-slider">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" style="background:url(images/11111.jpg) no-repeat">
          <div class="content">
            <div class="text">  
              <span>The journey is the destination</span>
        ...
        <div class="swiper-slide" style="background:url(images/nepal2.jpg) no-repeat">
          <div class="content">
            <div class="text">  
              <span>The journey is the destination</span>
...
<section class="home-packages">
    ...
    <div class="box-container">
        ...
        $query = "SELECT p.name, p.description, pi.image_path 
                  FROM package p 
                  JOIN package_images pi ON p.id = pi.package_id
...
<!-- offer section starts-->
  ...
  <section class ="home-offer">
    <div>
      <div class ="content">
        <h3>upto 50% off</h3>
        <p>on the oscupssion occasion of festivel (dashain and tihar) we provide you the affordable discount on your package and grab it as soon as possible.</p>
